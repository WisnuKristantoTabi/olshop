...
$routes->get('/shop', 'Dashboard::shop');
$routes->get('/shopdetail/(:num)', 'Dashboard::shopdetail/$1');
...
$routes->get('produkdelete/(:num)', 'Produk::delete/$1');
$routes->get('produkedit/(:any)', 'Produk::edit/$1');

// Beli
$routes->post('beli', 'Beli::proses');
