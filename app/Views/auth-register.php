                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        ...
                                        <form class="needs-validation custom-form mt-4 pt-2" novalidate action="/register/save" method="post" >
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="telepon" class="form-control" name="telepon" id="telepon" required>
                                                <div class="invalid-feedback">
