<meta charset="utf-8">
    ...
    <!-- Site Metas -->
    <title>Fadhilah Olshop</title>
    <meta name="keywords" content="">
    <meta name="description" content="">
    <meta name="author" content="">

    <!-- Site Icons -->
    <link rel="shortcut icon" href="<?php echo base_url('/assets/dashboard/images/logo.ico'); ?>" type="image/x-icon">
    <link rel="apple-touch-icon" href="<?php echo base_url('/assets/dashboard/images/apple-touch-icon.png' ); ?>">
