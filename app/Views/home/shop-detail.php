            ...
            <div class="row">
					...
					<!-- </a>
                        ...
                        <!-- <ol class="carousel-indicators"> -->
                            <!-- <li data-target="#carousel-example-1" data-slide-to="0" class="active"> -->
                                <img class="d-block w-500 img-fluid" src="<?php echo '/assets/dashboard/images/'.$produks->gambar ?>" alt="" />
                            <!-- </li> -->
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        ...
                        <h5><?= $produks->harga ?></h5>
                        <input type="text" name="namabarang"value="<?= $produks->nama_produk ?>" hidden>
                            ...
                            <p>
                                ...
                                <ul>
                                    <li>
                                        <div class="form-group size-st">
                                            ...
                                            <select id="basic" name="ukuran" class="selectpicker show-tick form-control">
                                    ...
                                    <li>
                                        <div class="form-group quantity-box">
                                            ...
                                            <input class="form-control" name="jumlah" value="0" min="0" max="20" type="number">
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div class="price-box-bar">
                                    <div class="cart-and-bay-btn">
                                        <input type="submit" class="btn" data-fancybox-close="" value="Beli">
                                    </div>
                                </div>
                            </form>
                        </div>
